...
-   [🔍 Core Concept: Model Redundancy & Phase Transitions](#core-concept-model-redundancy--phase-transitions)
    ...
    -   [⚡️ Model Phase Transition (MPT)](#model-phase-transition-mpt)
...
-   [📚 Papers](#papers)
    ...
    -   [✂️ Structured Pruning](#structured-pruning)
...
-   [📊 Case Studies](#case-studies)
    ...
    -   [🔨 Sensitivity to quantization](#sensitivity-to-quantization)
        -   [Features](#features-1)
    -   [Sensitivity to Low-Rank Decomposition](#sensitivity-to-low-rank-decomposition-1)
    -   [⭐️ Sensitivity to Combined Model Compression](#sensitivity-to-combined-model-compression-1)
